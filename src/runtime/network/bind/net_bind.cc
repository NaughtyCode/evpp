...
#include "runtime/network/bind/net_http_bind.h"
#include "runtime/network/bind/net_kcp_client_bind.h"
#include "runtime/network/bind/net_kcp_server_bind.h"
#include "runtime/network/bind/net_tcp_client_bind.h"
#include "runtime/network/bind/net_tcp_server_bind.h"
#include "runtime/network/bind/net_udp_client_bind.h"
#include "runtime/network/bind/net_udp_server_bind.h"
...
void ExportNet(ScriptVM& vm) {
	...
	ENGINE_LOG_INFO(logger,
					"ScriptBind: net module exported "
