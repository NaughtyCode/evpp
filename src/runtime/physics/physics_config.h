...
struct glz::meta<engine::LayerConfig> {
    ...
    static constexpr auto value = glz::object(
        "objectLayers", &T::object_layers,
        "broadPhaseLayers", &T::broad_phase_layers,
        "layerMapping", &T::layer_mapping,
        "collisionMatrix", &T::collision_matrix
    );
};
...
struct glz::meta<engine::PhysicsConfig> {
    ...
    static constexpr auto value = glz::object(
        "gravityX", &T::gravity_x,
        "gravityY", &T::gravity_y,
        "gravityZ", &T::gravity_z,
        "fixedDeltaTime", &T::fixed_delta_time,
        "solverIterations", &T::solver_iterations,
        "subStepCount", &T::sub_step_count,
        "maxBodies", &T::max_bodies,
        "maxContactPoints", &T::max_contact_points,
        "maxBodyPairs", &T::max_body_pairs,
        "numBodyMutexes", &T::num_body_mutexes,
        "positionIterations", &T::position_iterations,
        "speculativeContactDistance", &T::speculative_contact_distance,
        "penetrationSlop", &T::penetration_slop,
        "baumgarte", &T::baumgarte,
        "timeBeforeSleep", &T::time_before_sleep,
        "pointVelocitySleepThreshold", &T::point_velocity_sleep_threshold,
        "deterministicSimulation", &T::deterministic_simulation,
        "constraintWarmStart", &T::constraint_warm_start,
        "allowSleeping", &T::allow_sleeping,
        "useLargeIslandSplitter", &T::use_large_island_splitter,
        "linearCastThreshold", &T::linear_cast_threshold,
        "linearCastMaxPenetration", &T::linear_cast_max_penetration,
        "maxPenetrationDistance", &T::max_penetration_distance,
        "minVelocityForRestitution", &T::min_velocity_for_restitution,
        "useBodyPairContactCache", &T::use_body_pair_contact_cache,
        "useManifoldReduction", &T::use_manifold_reduction,
        "checkActiveEdges", &T::check_active_edges,
        "layerConfig", &T::layer_config
    );
};
...
struct glz::meta<engine::ThreadingConfig> {
    ...
    static constexpr auto value = glz::object(
        "threadPriority", &T::thread_priority,
        "affinityMask", &T::affinity_mask,
        "commandQueueSize", &T::command_queue_size,
        "resultQueueSize", &T::result_queue_size,
        "maxPendingFrames", &T::max_pending_frames,
        "jobSystemMaxJobs", &T::job_system_max_jobs,
        "jobSystemMaxBarriers", &T::job_system_max_barriers,
        "jobSystemThreadCount", &T::job_system_thread_count
    );
};
...
struct glz::meta<engine::PhysicsLogConfig> {
    ...
    static constexpr auto value = glz::object(
        ...
        "level", &T::level,
        "maxFileSizeMb", &T::max_file_size_mb,
        "maxBackupFiles", &T::max_backup_files,
        "rotationFrequency", &T::rotation_frequency,
        "rotationInterval", &T::rotation_interval,
        "rotationTimeDaily", &T::rotation_time_daily,
        "formatPattern", &T::format_pattern
    );
};
...
struct glz::meta<engine::ThresholdsConfig> {
    ...
    static constexpr auto value = glz::object(
        "positionEpsilon", &T::position_epsilon,
        "rotationEpsilon", &T::rotation_epsilon,
        "linearVelocityEpsilon", &T::linear_velocity_epsilon,
        "angularVelocityEpsilon", &T::angular_velocity_epsilon
    );
};
...
public:
    ...
    const ThreadingConfig& GetThreadingConfig() const { return threading_config_; }
    const PhysicsLogConfig& GetLogConfig() const { return log_config_; }
    const ThresholdsConfig& GetThresholdsConfig() const { return thresholds_config_; }
