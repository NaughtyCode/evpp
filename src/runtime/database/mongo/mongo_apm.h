...
using MongoApmServerHeartbeatStartedCb = std::function<void(const MongoApmServerHeartbeatStartedEvent&)>;
using MongoApmServerHeartbeatSucceededCb = std::function<void(const MongoApmServerHeartbeatSucceededEvent&)>;
using MongoApmServerHeartbeatFailedCb = std::function<void(const MongoApmServerHeartbeatFailedEvent&)>;
