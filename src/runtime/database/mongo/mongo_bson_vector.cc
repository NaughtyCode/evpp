...
bool BsonVectorInt8ConstView::Read(int8_t* values_out, size_t element_count,
                                    size_t vector_offset_elements) const {
    return bson_vector_int8_const_view_read(*CV8C(this), values_out, element_count, vector_offset_elements);
}
...
bool BsonVectorInt8View::FromIter(BsonIter& iter) {
    return bson_vector_int8_view_from_iter(VC8(this),
...
bool BsonVectorInt8View::Read(int8_t* values_out, size_t element_count,
                               size_t vector_offset_elements) const {
    return bson_vector_int8_view_read(*CV8(this), values_out, element_count, vector_offset_elements);
}

bool BsonVectorInt8View::Write(const int8_t* values, size_t element_count,
...
bool BsonVectorFloat32ConstView::FromIter(const BsonIter& iter) {
    return bson_vector_float32_const_view_from_iter(VF32C(this),
        static_cast<const bson_iter_t*>(iter.RawIter()));
}
...
bool BsonVectorFloat32ConstView::Read(float* values_out, size_t element_count,
                                       size_t vector_offset_elements) const {
    return bson_vector_float32_const_view_read(*CVF32C(this), values_out, element_count, vector_offset_elements);
}
...
bool BsonVectorFloat32View::Read(float* values_out, size_t element_count,
                                  size_t vector_offset_elements) const {
    return bson_vector_float32_view_read(*CVF32(this), values_out, element_count, vector_offset_elements);
}

bool BsonVectorFloat32View::Write(const float* values, size_t element_count,
                                   size_t vector_offset_elements) {
    return bson_vector_float32_view_write(*CVF32(this), values, element_count, vector_offset_elements);
}
...
bool BsonVectorPackedBitConstView::FromIter(const BsonIter& iter) {
    return bson_vector_packed_bit_const_view_from_iter(VPBC(this),
        static_cast<const bson_iter_t*>(iter.RawIter()));
}
...
bool BsonVectorPackedBitConstView::ReadPacked(uint8_t* packed_values_out, size_t byte_count,
                                               size_t vector_offset_bytes) const {
    return bson_vector_packed_bit_const_view_read_packed(*CVPBC(this), packed_values_out, byte_count, vector_offset_bytes);
}

bool BsonVectorPackedBitConstView::UnpackBool(bool* unpacked_values_out, size_t element_count,
                                               size_t vector_offset_elements) const {
    return bson_vector_packed_bit_const_view_unpack_bool(*CVPBC(this), unpacked_values_out, element_count, vector_offset_elements);
}
...
bool BsonVectorPackedBitView::ReadPacked(uint8_t* packed_values_out, size_t byte_count,
                                          size_t vector_offset_bytes) const {
    return bson_vector_packed_bit_view_read_packed(*CVPB(this), packed_values_out, byte_count, vector_offset_bytes);
}

bool BsonVectorPackedBitView::UnpackBool(bool* unpacked_values_out, size_t element_count,
                                          size_t vector_offset_elements) const {
    return bson_vector_packed_bit_view_unpack_bool(*CVPB(this), unpacked_values_out, element_count, vector_offset_elements);
}

bool BsonVectorPackedBitView::WritePacked(const uint8_t* packed_values, size_t byte_count,
                                           size_t vector_offset_bytes) {
    return bson_vector_packed_bit_view_write_packed(*CVPB(this), packed_values, byte_count, vector_offset_bytes);
}

bool BsonVectorPackedBitView::PackBool(const bool* unpacked_values, size_t element_count,
                                        size_t vector_offset_elements) {
    return bson_vector_packed_bit_view_pack_bool(*CVPB(this), unpacked_values, element_count, vector_offset_elements);
}
...
bool BsonAppendVectorInt8Uninit(BsonDocument& doc, const char* key,
                                 size_t element_count, BsonVectorInt8View& view_out) {
    return bson_append_vector_int8_uninit(
        static_cast<bson_t*>(doc.RawBson()), key, -1, element_count, VC8(&view_out));
}

bool BsonAppendVectorFloat32Uninit(BsonDocument& doc, const char* key,
                                    size_t element_count, BsonVectorFloat32View& view_out) {
    return bson_append_vector_float32_uninit(
        static_cast<bson_t*>(doc.RawBson()), key, -1, element_count, VF32(&view_out));
}

bool BsonAppendVectorPackedBitUninit(BsonDocument& doc, const char* key,
                                      size_t element_count, BsonVectorPackedBitView& view_out) {
    return bson_append_vector_packed_bit_uninit(
        static_cast<bson_t*>(doc.RawBson()), key, -1, element_count, VPB(&view_out));
}

bool BsonAppendVectorInt8FromArray(BsonDocument& doc, const char* key,
                                    const BsonIter& iter, MongoError* error) {
    bson_error_t err;
    return bson_append_vector_int8_from_array(
        static_cast<bson_t*>(doc.RawBson()), key, -1,
        static_cast<const bson_iter_t*>(iter.RawIter()),
        error ? static_cast<bson_error_t*>(error->RawError()) : &err);
}

bool BsonAppendVectorFloat32FromArray(BsonDocument& doc, const char* key,
                                       const BsonIter& iter, MongoError* error) {
    bson_error_t err;
...
bool BsonAppendVectorPackedBitFromArray(BsonDocument& doc, const char* key,
                                         const BsonIter& iter, MongoError* error) {
    bson_error_t err;
...
bool BsonAppendArrayFromVectorInt8(BsonDocument& doc, const char* key,
...
bool BsonAppendArrayFromVectorFloat32(BsonDocument& doc, const char* key,
...
bool BsonAppendArrayFromVectorPackedBit(BsonDocument& doc, const char* key,
