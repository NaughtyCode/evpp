...
void MongoSslOpts::SetWeakCertValidation(bool weak) {
	impl_->opts.weak_cert_validation = weak;
}
void MongoSslOpts::SetAllowInvalidHostname(bool allow) {
	impl_->opts.allow_invalid_hostname = allow;
}

const char* MongoSslOpts::GetPemFile() const {
	return impl_->opts.pem_file;
}
const char* MongoSslOpts::GetPemPwd() const {
	return impl_->opts.pem_pwd;
}
const char* MongoSslOpts::GetCaFile() const {
	return impl_->opts.ca_file;
}
const char* MongoSslOpts::GetCaDir() const {
	return impl_->opts.ca_dir;
}
const char* MongoSslOpts::GetCrlFile() const {
	return impl_->opts.crl_file;
}
bool MongoSslOpts::GetWeakCertValidation() const {
	return impl_->opts.weak_cert_validation;
}
bool MongoSslOpts::GetAllowInvalidHostname() const {
	return impl_->opts.allow_invalid_hostname;
}

const void* MongoSslOpts::GetDefault() {
	return mongoc_ssl_opt_get_default();
}
void* MongoSslOpts::Raw() {
	return &impl_->opts;
}
