...
public:
    ...
    MongoClientEncryptionRewrapManyDatakeyResult(const MongoClientEncryptionRewrapManyDatakeyResult&) = delete;
    MongoClientEncryptionRewrapManyDatakeyResult& operator=(const MongoClientEncryptionRewrapManyDatakeyResult&) = delete;
    MongoClientEncryptionRewrapManyDatakeyResult(MongoClientEncryptionRewrapManyDatakeyResult&&) noexcept;
    MongoClientEncryptionRewrapManyDatakeyResult& operator=(MongoClientEncryptionRewrapManyDatakeyResult&&) noexcept;
...
public:
    ...
    bool AddKeyAltName(const void* keyid, const char* keyaltname,
                       BsonDocument* key_doc, MongoError* error);
    bool RemoveKeyAltName(const void* keyid, const char* keyaltname,
                          BsonDocument* key_doc, MongoError* error);
    ...
    void* CreateEncryptedCollection(void* database, const char* name,
