...
MongoBulkWriteInsertOneOpts::MongoBulkWriteInsertOneOpts() : impl_(std::make_unique<Impl>()) {
...
MongoBulkWriteInsertOneOpts::MongoBulkWriteInsertOneOpts(MongoBulkWriteInsertOneOpts&&) noexcept =
	default;
MongoBulkWriteInsertOneOpts& MongoBulkWriteInsertOneOpts::operator=(
	MongoBulkWriteInsertOneOpts&& other) noexcept {
	if (this != &other) {
		if (impl_ && impl_->opts) mongoc_bulkwrite_insertoneopts_destroy(impl_->opts);
...
void* MongoBulkWriteInsertOneOpts::Raw() {
	return impl_ ? impl_->opts : nullptr;
}
const void* MongoBulkWriteInsertOneOpts::Raw() const {
	return impl_ ? impl_->opts : nullptr;
}
...
MongoBulkWriteUpdateOneOpts::MongoBulkWriteUpdateOneOpts() : impl_(std::make_unique<Impl>()) {
...
MongoBulkWriteUpdateOneOpts::MongoBulkWriteUpdateOneOpts(MongoBulkWriteUpdateOneOpts&&) noexcept =
	default;
MongoBulkWriteUpdateOneOpts& MongoBulkWriteUpdateOneOpts::operator=(
	MongoBulkWriteUpdateOneOpts&& other) noexcept {
	if (this != &other) {
		if (impl_ && impl_->opts) mongoc_bulkwrite_updateoneopts_destroy(impl_->opts);
		impl_ = std::move(other.impl_);
	}
...
void MongoBulkWriteUpdateOneOpts::SetUpsert(bool upsert) {
	if (impl_ && impl_->opts) mongoc_bulkwrite_updateoneopts_set_upsert(impl_->opts, upsert);
}
...
void* MongoBulkWriteUpdateOneOpts::Raw() {
	return impl_ ? impl_->opts : nullptr;
}
const void* MongoBulkWriteUpdateOneOpts::Raw() const {
	return impl_ ? impl_->opts : nullptr;
}
...
MongoBulkWriteUpdateManyOpts::MongoBulkWriteUpdateManyOpts() : impl_(std::make_unique<Impl>()) {
...
MongoBulkWriteUpdateManyOpts::MongoBulkWriteUpdateManyOpts(
	MongoBulkWriteUpdateManyOpts&&) noexcept = default;
MongoBulkWriteUpdateManyOpts& MongoBulkWriteUpdateManyOpts::operator=(
	MongoBulkWriteUpdateManyOpts&& other) noexcept {
	if (this != &other) {
		if (impl_ && impl_->opts) mongoc_bulkwrite_updatemanyopts_destroy(impl_->opts);
		impl_ = std::move(other.impl_);
	}
...
void MongoBulkWriteUpdateManyOpts::SetUpsert(bool upsert) {
	if (impl_ && impl_->opts) mongoc_bulkwrite_updatemanyopts_set_upsert(impl_->opts, upsert);
}

void* MongoBulkWriteUpdateManyOpts::Raw() {
	return impl_ ? impl_->opts : nullptr;
}
const void* MongoBulkWriteUpdateManyOpts::Raw() const {
	return impl_ ? impl_->opts : nullptr;
}
...
MongoBulkWriteReplaceOneOpts::MongoBulkWriteReplaceOneOpts() : impl_(std::make_unique<Impl>()) {
...
MongoBulkWriteReplaceOneOpts::MongoBulkWriteReplaceOneOpts(
	MongoBulkWriteReplaceOneOpts&&) noexcept = default;
MongoBulkWriteReplaceOneOpts& MongoBulkWriteReplaceOneOpts::operator=(
	MongoBulkWriteReplaceOneOpts&& other) noexcept {
	if (this != &other) {
		if (impl_ && impl_->opts) mongoc_bulkwrite_replaceoneopts_destroy(impl_->opts);
		impl_ = std::move(other.impl_);
	}
...
void MongoBulkWriteReplaceOneOpts::SetUpsert(bool upsert) {
	if (impl_ && impl_->opts) mongoc_bulkwrite_replaceoneopts_set_upsert(impl_->opts, upsert);
}
...
void* MongoBulkWriteReplaceOneOpts::Raw() {
	return impl_ ? impl_->opts : nullptr;
}
const void* MongoBulkWriteReplaceOneOpts::Raw() const {
	return impl_ ? impl_->opts : nullptr;
}
...
MongoBulkWriteDeleteOneOpts::MongoBulkWriteDeleteOneOpts() : impl_(std::make_unique<Impl>()) {
...
MongoBulkWriteDeleteOneOpts::MongoBulkWriteDeleteOneOpts(MongoBulkWriteDeleteOneOpts&&) noexcept =
	default;
MongoBulkWriteDeleteOneOpts& MongoBulkWriteDeleteOneOpts::operator=(
	MongoBulkWriteDeleteOneOpts&& other) noexcept {
	if (this != &other) {
		if (impl_ && impl_->opts) mongoc_bulkwrite_deleteoneopts_destroy(impl_->opts);
		impl_ = std::move(other.impl_);
	}
...
void* MongoBulkWriteDeleteOneOpts::Raw() {
	return impl_ ? impl_->opts : nullptr;
}
const void* MongoBulkWriteDeleteOneOpts::Raw() const {
	return impl_ ? impl_->opts : nullptr;
}
...
MongoBulkWriteDeleteManyOpts::MongoBulkWriteDeleteManyOpts() : impl_(std::make_unique<Impl>()) {
...
MongoBulkWriteDeleteManyOpts::MongoBulkWriteDeleteManyOpts(
	MongoBulkWriteDeleteManyOpts&&) noexcept = default;
MongoBulkWriteDeleteManyOpts& MongoBulkWriteDeleteManyOpts::operator=(
	MongoBulkWriteDeleteManyOpts&& other) noexcept {
	if (this != &other) {
		if (impl_ && impl_->opts) mongoc_bulkwrite_deletemanyopts_destroy(impl_->opts);
		impl_ = std::move(other.impl_);
	}
...
void* MongoBulkWriteDeleteManyOpts::Raw() {
	return impl_ ? impl_->opts : nullptr;
}
const void* MongoBulkWriteDeleteManyOpts::Raw() const {
	return impl_ ? impl_->opts : nullptr;
}
...
MongoBulkWriteOpts::MongoBulkWriteOpts() : impl_(std::make_unique<Impl>()) {
...
void MongoBulkWriteOpts::SetOrdered(bool ordered) {
	if (impl_ && impl_->opts) mongoc_bulkwriteopts_set_ordered(impl_->opts, ordered);
}
...
void MongoBulkWriteOpts::SetLet(const BsonDocument& let) {
	if (impl_ && impl_->opts)
		mongoc_bulkwriteopts_set_let(impl_->opts, static_cast<const bson_t*>(let.RawBson()));
}
...
void MongoBulkWriteOpts::SetComment(const void* comment) {
	if (impl_ && impl_->opts)
		mongoc_bulkwriteopts_set_comment(impl_->opts, static_cast<const bson_value_t*>(comment));
}

void MongoBulkWriteOpts::SetVerboseResults(bool verbose) {
	if (impl_ && impl_->opts) mongoc_bulkwriteopts_set_verboseresults(impl_->opts, verbose);
}

void MongoBulkWriteOpts::SetExtra(const BsonDocument& extra) {
	if (impl_ && impl_->opts)
		mongoc_bulkwriteopts_set_extra(impl_->opts, static_cast<const bson_t*>(extra.RawBson()));
}

void MongoBulkWriteOpts::SetServerId(uint32_t server_id) {
	if (impl_ && impl_->opts) mongoc_bulkwriteopts_set_serverid(impl_->opts, server_id);
}

void* MongoBulkWriteOpts::Raw() {
	return impl_ ? impl_->opts : nullptr;
}
const void* MongoBulkWriteOpts::Raw() const {
	return impl_ ? impl_->opts : nullptr;
}
...
MongoBulkWriteException& MongoBulkWriteException::operator=(
	MongoBulkWriteException&& other) noexcept {
	if (this != &other) {
		if (impl_ && impl_->exc) mongoc_bulkwriteexception_destroy(impl_->exc);
		impl_ = std::move(other.impl_);
	}
...
bool MongoBulkWriteException::Error(MongoError* error) const {
	return impl_ && impl_->exc &&
		   mongoc_bulkwriteexception_error(
			   impl_->exc, error ? static_cast<bson_error_t*>(error->RawError()) : nullptr);
}
...
void* MongoBulkWriteException::Raw() {
	return impl_ ? impl_->exc : nullptr;
}
...
bool MongoBulkWrite::AppendInsertOne(const char* ns,
									 ...
									 const MongoBulkWriteInsertOneOpts* opts,
									 MongoError* error) {
	if (!impl_ || !impl_->bw) return false;
	return mongoc_bulkwrite_append_insertone(
		impl_->bw,
		ns,
...
bool MongoBulkWrite::AppendUpdateOne(const char* ns,
									 const BsonDocument& filter,
									 const BsonDocument& update,
									 const MongoBulkWriteUpdateOneOpts* opts,
									 MongoError* error) {
	if (!impl_ || !impl_->bw) return false;
	return mongoc_bulkwrite_append_updateone(
		impl_->bw,
		ns,
...
bool MongoBulkWrite::AppendUpdateMany(const char* ns,
									  const BsonDocument& filter,
									  const BsonDocument& update,
									  const MongoBulkWriteUpdateManyOpts* opts,
									  MongoError* error) {
	if (!impl_ || !impl_->bw) return false;
	return mongoc_bulkwrite_append_updatemany(
		impl_->bw,
		ns,
		static_cast<const bson_t*>(filter.RawBson()),
		static_cast<const bson_t*>(update.RawBson()),
...
bool MongoBulkWrite::AppendReplaceOne(const char* ns,
									  const BsonDocument& filter,
									  const BsonDocument& replacement,
									  const MongoBulkWriteReplaceOneOpts* opts,
									  MongoError* error) {
	if (!impl_ || !impl_->bw) return false;
	return mongoc_bulkwrite_append_replaceone(
		impl_->bw,
		ns,
		static_cast<const bson_t*>(filter.RawBson()),
...
bool MongoBulkWrite::AppendDeleteOne(const char* ns,
									 const BsonDocument& filter,
									 const MongoBulkWriteDeleteOneOpts* opts,
									 MongoError* error) {
	if (!impl_ || !impl_->bw) return false;
	return mongoc_bulkwrite_append_deleteone(
		impl_->bw,
		ns,
		static_cast<const bson_t*>(filter.RawBson()),
...
bool MongoBulkWrite::AppendDeleteMany(const char* ns,
									  const BsonDocument& filter,
									  const MongoBulkWriteDeleteManyOpts* opts,
									  MongoError* error) {
	if (!impl_ || !impl_->bw) return false;
	return mongoc_bulkwrite_append_deletemany(
		impl_->bw,
		ns,
		static_cast<const bson_t*>(filter.RawBson()),
...
MongoBulkWriteReturn MongoBulkWrite::Execute(const MongoBulkWriteOpts* opts) {
	...
	mongoc_bulkwritereturn_t raw_ret = mongoc_bulkwrite_execute(
...
MongoBulkWriteCheckAcknowledged MongoBulkWrite::CheckAcknowledged(MongoError* error) const {
	...
	if (!impl_ || !impl_->bw) return ret;
	mongoc_bulkwrite_check_acknowledged_t raw = mongoc_bulkwrite_check_acknowledged(
		impl_->bw, error ? static_cast<bson_error_t*>(error->RawError()) : nullptr);
	ret.is_ok = raw.is_ok;
...
MongoBulkWriteServerId MongoBulkWrite::ServerId(MongoError* error) const {
	...
	if (!impl_ || !impl_->bw) return ret;
	mongoc_bulkwrite_serverid_t raw = mongoc_bulkwrite_serverid(
		impl_->bw, error ? static_cast<bson_error_t*>(error->RawError()) : nullptr);
	ret.is_ok = raw.is_ok;
...
void MongoBulkWrite::SetSession(void* session) {
	if (impl_ && impl_->bw)
		mongoc_bulkwrite_set_session(impl_->bw, static_cast<mongoc_client_session_t*>(session));
}

bool MongoBulkWrite::SetClient(void* client) {
	if (!impl_ || !impl_->bw) return false;
	mongoc_bulkwrite_set_client(impl_->bw, static_cast<mongoc_client_t*>(client));
	return true;
}

void* MongoBulkWrite::Raw() {
	return impl_ ? impl_->bw : nullptr;
}
