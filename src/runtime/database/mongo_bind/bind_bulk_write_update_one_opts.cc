...
const char* kMetaName = "mongoc.bulk_write_update_one_opts";

int l_opts_gc(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoBulkWriteUpdateOneOpts>(L, 1, kMetaName);
    delete opts;
    *CheckUserdata<mongo::MongoBulkWriteUpdateOneOpts>(L, 1, kMetaName) = nullptr;
    return 0;
}

int l_opts_new(lua_State* L) {
    auto* opts = new (std::nothrow) mongo::MongoBulkWriteUpdateOneOpts();
...
int l_opts_destroy(lua_State* L) { l_opts_gc(L); return 0; }
...
const luaL_Reg kLib[] = {
    {"bulk_write_update_one_opts_new", l_opts_new},
    {"bulk_write_update_one_opts_destroy", l_opts_destroy},
    {"bulk_write_update_one_opts_set_array_filters", l_opts_set_array_filters},
    {"bulk_write_update_one_opts_set_collation", l_opts_set_collation},
    {"bulk_write_update_one_opts_set_hint", l_opts_set_hint},
    {"bulk_write_update_one_opts_set_upsert", l_opts_set_upsert},
    {"bulk_write_update_one_opts_set_sort", l_opts_set_sort},
    {nullptr, nullptr},
};
...
const luaL_Reg* GetMongoBulkWriteUpdateOneOptsLib() { return kLib; }
