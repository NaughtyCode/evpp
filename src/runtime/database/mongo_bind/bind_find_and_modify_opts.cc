...
int l_find_and_modify_destroy(lua_State* L) { l_find_and_modify_gc(L); return 0; }
...
const luaL_Reg kLib[] = {
    ...
    {"find_and_modify_opts_set_bypass_document_validation", l_find_and_modify_set_bypass_document_validation},
    {"find_and_modify_opts_get_bypass_document_validation", l_find_and_modify_get_bypass_document_validation},
