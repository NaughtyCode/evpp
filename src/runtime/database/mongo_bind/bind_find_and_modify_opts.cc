...
int l_get_bypass_document_validation(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoFindAndModifyOpts>(L, 1, kMetaName);
    lua_pushboolean(L, opts && opts->GetBypassDocumentValidation());
    return 1;
}

int l_set_max_time_ms(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoFindAndModifyOpts>(L, 1, kMetaName);
...
int l_get_max_time_ms(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoFindAndModifyOpts>(L, 1, kMetaName);
...
const luaL_Reg kLib[] = {
    {"find_and_modify_opts_new", l_new},
    {"find_and_modify_opts_destroy", l_destroy},
    {"find_and_modify_opts_set_sort", l_set_sort},
    {"find_and_modify_opts_get_sort", l_get_sort},
    {"find_and_modify_opts_set_update", l_set_update},
    {"find_and_modify_opts_get_update", l_get_update},
    {"find_and_modify_opts_set_fields", l_set_fields},
    {"find_and_modify_opts_get_fields", l_get_fields},
    {"find_and_modify_opts_set_flags", l_set_flags},
    {"find_and_modify_opts_get_flags", l_get_flags},
    {"find_and_modify_opts_set_bypass_document_validation", l_set_bypass_document_validation},
    {"find_and_modify_opts_get_bypass_document_validation", l_get_bypass_document_validation},
    {"find_and_modify_opts_set_max_time_ms", l_set_max_time_ms},
    {"find_and_modify_opts_get_max_time_ms", l_get_max_time_ms},
    {"find_and_modify_opts_append", l_append},
    {"find_and_modify_opts_get_extra", l_get_extra},
    {nullptr, nullptr},
};
...
const luaL_Reg* GetMongoFindAndModifyOptsLib() { return kLib; }
