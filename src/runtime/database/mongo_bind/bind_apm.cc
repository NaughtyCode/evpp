...
int l_apm_cmd_started_new(lua_State* L) {
    ...
    if (!raw) { lua_pushnil(L); lua_pushstring(L, "raw event pointer required"); return 2; }
    auto* ev = new (std::nothrow) mongo::MongoApmCommandStartedEvent(raw);
    if (!ev) { lua_pushnil(L); lua_pushstring(L, "allocation failure"); return 2; }
    auto** ud = NewUserdata<mongo::MongoApmCommandStartedEvent>(L, kMetaCmdStarted);
    *ud = ev;
    return 1;
}

int l_apm_cmd_started_destroy(lua_State* L) { l_apm_cmd_started_gc(L); return 0; }

int l_apm_cmd_started_get_command(lua_State* L) {
    auto* ev = GetUserdata<mongo::MongoApmCommandStartedEvent>(L, 1, kMetaCmdStarted);
    if (!ev) { lua_pushnil(L); return 1; }
...
int l_apm_cmd_succeeded_destroy(lua_State* L) { l_apm_cmd_succeeded_gc(L); return 0; }
...
int l_apm_cmd_failed_destroy(lua_State* L) { l_apm_cmd_failed_gc(L); return 0; }
...
int l_apm_server_changed_destroy(lua_State* L) { l_apm_server_changed_gc(L); return 0; }
...
int l_apm_server_opening_destroy(lua_State* L) { l_apm_server_opening_gc(L); return 0; }
...
int l_apm_server_closed_destroy(lua_State* L) { l_apm_server_closed_gc(L); return 0; }
...
int l_apm_topology_changed_destroy(lua_State* L) { l_apm_topology_changed_gc(L); return 0; }
...
int l_apm_topology_opening_destroy(lua_State* L) { l_apm_topology_opening_gc(L); return 0; }
...
int l_apm_topology_closed_destroy(lua_State* L) { l_apm_topology_closed_gc(L); return 0; }
...
int l_apm_hb_started_destroy(lua_State* L) { l_apm_hb_started_gc(L); return 0; }
...
int l_apm_hb_succeeded_destroy(lua_State* L) { l_apm_hb_succeeded_gc(L); return 0; }
...
int l_apm_hb_failed_destroy(lua_State* L) { l_apm_hb_failed_gc(L); return 0; }
...
int l_apm_callbacks_new(lua_State* L) {
    ...
    if (!cb) { lua_pushnil(L); lua_pushstring(L, "allocation failure"); return 2; }
    auto** ud = NewUserdata<mongo::MongoApmCallbacks>(L, kMetaCallbacks);
    *ud = cb;
    return 1;
}

int l_apm_callbacks_destroy(lua_State* L) { l_apm_callbacks_gc(L); return 0; }
...
const luaL_Reg* GetMongoApmCommandStartedEventLib() { return kCmdStartedLib; }
const luaL_Reg* GetMongoApmCommandSucceededEventLib() { return kCmdSucceededLib; }
const luaL_Reg* GetMongoApmCommandFailedEventLib() { return kCmdFailedLib; }
const luaL_Reg* GetMongoApmServerChangedEventLib() { return kServerChangedLib; }
const luaL_Reg* GetMongoApmServerOpeningEventLib() { return kServerOpeningLib; }
const luaL_Reg* GetMongoApmServerClosedEventLib() { return kServerClosedLib; }
const luaL_Reg* GetMongoApmTopologyChangedEventLib() { return kTopologyChangedLib; }
const luaL_Reg* GetMongoApmTopologyOpeningEventLib() { return kTopologyOpeningLib; }
const luaL_Reg* GetMongoApmTopologyClosedEventLib() { return kTopologyClosedLib; }
const luaL_Reg* GetMongoApmServerHeartbeatStartedEventLib() { return kHbStartedLib; }
const luaL_Reg* GetMongoApmServerHeartbeatSucceededEventLib() { return kHbSucceededLib; }
const luaL_Reg* GetMongoApmServerHeartbeatFailedEventLib() { return kHbFailedLib; }
const luaL_Reg* GetMongoApmCallbacksLib() { return kCallbacksLib; }
