...
int l_set_max_commit_time_ms(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoTransactionOpts>(L, 1, kMetaName);
...
int l_get_max_commit_time_ms(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoTransactionOpts>(L, 1, kMetaName);
...
const luaL_Reg kLib[] = {
    {"transaction_opts_new", l_new},
    {"transaction_opts_destroy", l_destroy},
    {"transaction_opts_clone", l_clone},
    {"transaction_opts_set_max_commit_time_ms", l_set_max_commit_time_ms},
    {"transaction_opts_get_max_commit_time_ms", l_get_max_commit_time_ms},
    {"transaction_opts_set_read_concern", l_set_read_concern},
    {"transaction_opts_set_write_concern", l_set_write_concern},
    {"transaction_opts_set_read_prefs", l_set_read_prefs},
    {nullptr, nullptr},
};
