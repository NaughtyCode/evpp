...
int l_auto_encrypt_opts_destroy(lua_State* L) { l_auto_encrypt_opts_gc(L); return 0; }
...
int l_auto_encrypt_opts_get_raw(lua_State* L) {
    ...
    void* raw = opts->Raw();
    if (raw) lua_pushlightuserdata(L, raw);
    else lua_pushnil(L);
    return 1;
}
...
const luaL_Reg kAeoLib[] = {
    ...
    {"auto_encrypt_opts_set_bypass_auto_encryption", l_auto_encrypt_opts_set_bypass_auto_encryption},
...
int l_client_encrypt_opts_destroy(lua_State* L) { l_client_encrypt_opts_gc(L); return 0; }
...
int l_encrypt_opts_destroy(lua_State* L) { l_encrypt_opts_gc(L); return 0; }
...
int l_encrypt_opts_set_range_opts(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoClientEncryptionEncryptOpts>(L, 1, kEncMeta);
    auto* range_opts = GetUserdata<mongo::MongoClientEncryptionEncryptRangeOpts>(L, 2,
        "mongoc.encrypt_range_opts");
...
int l_encrypt_opts_set_text_opts(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoClientEncryptionEncryptOpts>(L, 1, kEncMeta);
    auto* text_opts = GetUserdata<mongo::MongoClientEncryptionEncryptTextOpts>(L, 2,
        "mongoc.encrypt_text_opts");
...
int l_encrypt_range_opts_destroy(lua_State* L) { l_encrypt_range_opts_gc(L); return 0; }
...
int l_encrypt_text_prefix_opts_destroy(lua_State* L) { l_encrypt_text_prefix_opts_gc(L); return 0; }
...
const luaL_Reg kTpLib[] = {
    ...
    {"encrypt_text_prefix_opts_set_max_query_length", l_encrypt_text_prefix_opts_set_max_query_length},
    {"encrypt_text_prefix_opts_set_min_query_length", l_encrypt_text_prefix_opts_set_min_query_length},
...
int l_encrypt_text_suffix_opts_destroy(lua_State* L) { l_encrypt_text_suffix_opts_gc(L); return 0; }
...
const luaL_Reg kTsLib[] = {
    ...
    {"encrypt_text_suffix_opts_set_max_query_length", l_encrypt_text_suffix_opts_set_max_query_length},
    {"encrypt_text_suffix_opts_set_min_query_length", l_encrypt_text_suffix_opts_set_min_query_length},
...
int l_encrypt_text_substring_opts_destroy(lua_State* L) { l_encrypt_text_substring_opts_gc(L); return 0; }
...
const luaL_Reg kTssLib[] = {
    ...
    {"encrypt_text_substring_opts_set_max_query_length", l_encrypt_text_substring_opts_set_max_query_length},
    {"encrypt_text_substring_opts_set_min_query_length", l_encrypt_text_substring_opts_set_min_query_length},
...
int l_encrypt_text_opts_destroy(lua_State* L) { l_encrypt_text_opts_gc(L); return 0; }

int l_encrypt_text_opts_set_prefix(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoClientEncryptionEncryptTextOpts>(L, 1, kTxtMeta);
    auto* prefix = lua_isnoneornil(L, 2) ? nullptr
                   : GetUserdata<mongo::MongoClientEncryptionEncryptTextPrefixOpts>(L, 2,
                       "mongoc.encrypt_text_prefix_opts");
...
int l_encrypt_text_opts_set_suffix(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoClientEncryptionEncryptTextOpts>(L, 1, kTxtMeta);
    auto* suffix = lua_isnoneornil(L, 2) ? nullptr
                   : GetUserdata<mongo::MongoClientEncryptionEncryptTextSuffixOpts>(L, 2,
                       "mongoc.encrypt_text_suffix_opts");
...
int l_encrypt_text_opts_set_substring(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoClientEncryptionEncryptTextOpts>(L, 1, kTxtMeta);
    auto* sub = lua_isnoneornil(L, 2) ? nullptr
                : GetUserdata<mongo::MongoClientEncryptionEncryptTextSubstringOpts>(L, 2,
                    "mongoc.encrypt_text_substring_opts");
...
int l_datakey_opts_destroy(lua_State* L) { l_datakey_opts_gc(L); return 0; }
...
int l_datakey_opts_set_key_material(lua_State* L) {
    ...
    if (opts) opts->SetKeyMaterial(reinterpret_cast<const uint8_t*>(data),
...
int l_rewrap_result_destroy(lua_State* L) { l_rewrap_result_gc(L); return 0; }
...
int l_client_encryption_new(lua_State* L) {
    auto* opts = GetUserdata<mongo::MongoClientEncryptionOpts>(L, 1, "mongoc.client_encryption_opts");
    if (!opts) { lua_pushnil(L); lua_pushstring(L, "invalid opts"); return 2; }
...
int l_client_encryption_destroy(lua_State* L) { l_client_encryption_gc(L); return 0; }
...
int l_client_encryption_rewrap_many_datakey(lua_State* L) {
    ...
    auto* master_key = lua_isnoneornil(L, 4) ? nullptr
                       : GetUserdata<mongo::BsonDocument>(L, 4, "bson.doc");
    if (!enc || !filter) { lua_pushboolean(L, false); lua_pushstring(L, "invalid args"); return 2; }
    ...
    if (!ok) {
        ...
        lua_pushnil(L);
        auto* copy = new (std::nothrow) mongo::MongoClientEncryptionRewrapManyDatakeyResult(
            std::move(result));
        if (!copy) {
            lua_pushnil(L);
            lua_pushnil(L);
...
bool push_key_management_reply(lua_State* L, const char* meta, bool ok,
                                mongo::BsonDocument& reply, const mongo::MongoError& error) {
    lua_pushboolean(L, ok);
    if (!ok) {
        lua_pushstring(L, error.Message());
        lua_pushnil(L);
...
int l_client_encryption_delete_key(lua_State* L) {
    auto* enc = GetUserdata<mongo::MongoClientEncryption>(L, 1, kCeMeta);
    void* keyid = lua_touserdata(L, 2);
    if (!enc) { lua_pushboolean(L, false); lua_pushstring(L, "invalid encryption"); return 2; }
...
int l_client_encryption_encrypt_expression(lua_State* L) {
    ...
    auto* opts = lua_isnoneornil(L, 3) ? nullptr
                 : GetUserdata<mongo::MongoClientEncryptionEncryptOpts>(L, 3, kEncMeta);
    if (!enc || !expr) { lua_pushboolean(L, false); lua_pushstring(L, "invalid args"); return 2; }
...
int l_client_encryption_get_crypt_shared_version(lua_State* L) {
    ...
    if (version) lua_pushstring(L, version);
    else lua_pushnil(L);
    return 1;
}
...
const luaL_Reg* GetMongoAutoEncryptionOptsLib() { return kAeoLib; }
const luaL_Reg* GetMongoClientEncryptionOptsLib() { return kCeoLib; }
const luaL_Reg* GetMongoClientEncryptionEncryptOptsLib() { return kEncLib; }
const luaL_Reg* GetMongoClientEncryptionEncryptRangeOptsLib() { return kErLib; }
const luaL_Reg* GetMongoClientEncryptionEncryptTextPrefixOptsLib() { return kTpLib; }
const luaL_Reg* GetMongoClientEncryptionEncryptTextSuffixOptsLib() { return kTsLib; }
const luaL_Reg* GetMongoClientEncryptionEncryptTextSubstringOptsLib() { return kTssLib; }
const luaL_Reg* GetMongoClientEncryptionEncryptTextOptsLib() { return kTxtLib; }
const luaL_Reg* GetMongoClientEncryptionDatakeyOptsLib() { return kDkLib; }
const luaL_Reg* GetMongoClientEncryptionRewrapManyDatakeyResultLib() { return kRwrLib; }
const luaL_Reg* GetMongoClientEncryptionLib() { return kCeLib; }
