...
private:
    ...
    moodycamel::ConcurrentQueue<DbRequest>  request_queue_;        // [SPSC] MT → DBT (MT: enqueue, DBT: try_dequeue)
    moodycamel::ConcurrentQueue<DbResponse> response_queue_;       // [SPSC] DBT → MT (DBT: enqueue, MT: try_dequeue)
