...
#define ENGINE_LOG_DEBUG_LIMIT(d, logger, fmt, ...) LOG_DEBUG_LIMIT(d, logger, fmt, ##__VA_ARGS__)
#define ENGINE_LOG_INFO_LIMIT(d, logger, fmt, ...) LOG_INFO_LIMIT(d, logger, fmt, ##__VA_ARGS__)
#define ENGINE_LOG_WARN_LIMIT(d, logger, fmt, ...) LOG_WARNING_LIMIT(d, logger, fmt, ##__VA_ARGS__)
#define ENGINE_LOG_ERROR_LIMIT(d, logger, fmt, ...) LOG_ERROR_LIMIT(d, logger, fmt, ##__VA_ARGS__)
