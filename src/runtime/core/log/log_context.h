...
public:
    ...
    static void set_player_id(uint64_t id) { player_id_ = id; }
    static uint64_t player_id() { return player_id_; }

    static void set_room_id(uint64_t id) { room_id_ = id; }
    static uint64_t room_id() { return room_id_; }
