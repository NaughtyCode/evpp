...
#include "engine/profiler/profiler_categories.h"
...
#define ENGINE_PROFILE_SCOPE(cat, name, ...) \
    TRACE_EVENT(cat, name, ##__VA_ARGS__)
...
#define ENGINE_PROFILE_FUNC() \
    ENGINE_PROFILE_SCOPE("engine", __func__)
...
#define ENGINE_PROFILE_SCOPE(cat, name, ...)                              do {} while (0)
#define ENGINE_PROFILE_BEGIN(cat, name, ...)                              do {} while (0)
#define ENGINE_PROFILE_END(cat)                                           do {} while (0)
#define ENGINE_PROFILE_INSTANT(cat, name)                                 do {} while (0)
#define ENGINE_PROFILE_COUNTER(cat, name, value)                          do {} while (0)
#define ENGINE_PROFILE_COUNTER_TRACK(cat, track, value)                   do {} while (0)
#define ENGINE_PROFILE_FUNC()                                             do {} while (0)
#define ENGINE_PROFILE_FLOW_BEGIN(cat, name, flow_id)                     do {} while (0)
#define ENGINE_PROFILE_FLOW_END(cat)                                      do {} while (0)
#define ENGINE_PROFILE_FLOW_TERMINATE(cat, name, flow_id)                 do {} while (0)
