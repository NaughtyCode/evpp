set(ENGINE_LUA_CORE_SOURCES
    ...
    ${CMAKE_CURRENT_LIST_DIR}/src/lstate_custom_ptr.c
)

set(ENGINE_LUA_LIB_SOURCES
...
set(ENGINE_LUA_SOURCES ${ENGINE_LUA_CORE_SOURCES} ${ENGINE_LUA_LIB_SOURCES})
